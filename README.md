...
- **Group datasets**: `cn_dataset`, `cnxcn_dataset` -- full group multiplication tables for TwoLayerNet (for other groups, use `build_modular_addition_sequence_dataset_generic` with `k=2`)
